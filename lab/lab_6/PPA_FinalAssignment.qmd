---
title: "Identifying Financially Vulnerable Homeowners: A Predictive Model for Property Tax Delinquency in Philadelphia"
subtitle: "CPLN 5080 - Spring 2026"
author: Jenny Brar, Maude Ceruso, Shubhanga Satya, Vedika Jawa
date: May 8, 2026
format:
  html:
    code-fold: show
...
bid <- st_read("data/business_improvement_districts.shp")%>%
  st_transform(crs=2272)

bid <- bid %>%
  select(geometry, organizati)
